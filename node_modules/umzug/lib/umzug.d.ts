...
import { MigrateDownOptions, MigrateUpOptions, MigrationMeta, MigrationParams, Promisable, Resolver, RunnableMigration, UmzugEvents, UmzugOptions } from './types';
interface MigrationErrorParams extends MigrationParams<unknown> {
    direction: 'up' | 'down';
}
export declare class Rethrowable extends VError {
    static wrap(throwable: unknown): VError;
}
export declare class MigrationError extends VError {
...
export declare class Umzug<Ctx extends object = object> extends emittery<UmzugEvents<Ctx>> {
     ...
     */
    extend(transform: (migrations: ReadonlyArray<RunnableMigration<Ctx>>) => Promisable<Array<RunnableMigration<Ctx>>>): Umzug<Ctx>;
