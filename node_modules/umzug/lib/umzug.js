...
exports.Umzug = exports.MigrationError = exports.Rethrowable = void 0;
...
class Rethrowable extends VError {
    static wrap(throwable) {
        ...
        }, `Non-error value thrown. See info for full props: %s`, throwable);
    }
}
exports.Rethrowable = Rethrowable;
class MigrationError extends VError {
    constructor(migration, original) {
        super({
            cause: Rethrowable.wrap(original),
            name: 'MigrationError',
            info: migration,
        }, 'Migration %s (%s) failed', migration.name, migration.direction);
    }
}
...
class Umzug extends emittery {
    ...
    options) {
        ...
        this.storage = storage_1.verifyUmzugStorage((_a = options.storage) !== null && _a !== void 0 ? _a : new storage_1.JSONStorage());
        this.migrations = this.getMigrationsResolver(this.options.migrations);
    }
    logging(message) {
        var _a;
        (_a = this.options.logger) === null || _a === void 0 ? void 0 : _a.info(message);
    }
    /**
    ...
    async up(options = {}) {
        const eligibleMigrations = async (context) => {
            ...
            let sliceIndex = (_a = options.step) !== null && _a !== void 0 ? _a : allPending.length;
            if (options.to) {
    ...
    async down(options = {}) {
        const eligibleMigrations = async (context) => {
            ...
            let sliceIndex = (_a = options.step) !== null && _a !== void 0 ? _a : 1;
        ...
        return this.runCommand('down', async ({ context }) => {
            ...
            for (const m of toBeReverted) {
                ...
                try {
                    await ((_a = m.down) === null || _a === void 0 ? void 0 : _a.call(m, params));
                }
                catch (e) {
    ...
    async create(options) {
        await this.runCommand('create', async ({ context }) => {
            ...
            const prefixType = (_a = options.prefix) !== null && _a !== void 0 ? _a : 'TIMESTAMP';
    ...
    getMigrationsResolver(inputMigrations) {
        ...
        const resolver = (_a = inputMigrations.resolve) !== null && _a !== void 0 ? _a : Umzug.defaultResolver;
